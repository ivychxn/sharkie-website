export const wishlistItemData = [{
  ...
  },
  {
    ...
    images: [{
      ...
      imagePath: require('../assets/purple-green-joycon.png'),
      imgAlt: 'pastel purple / pastel green joycons',
      indicatorText: 'pastel purple / pastel green'
    }, {
      imagePath: require('../assets/pink-yellow-joycon.png'),
    ...
    they come in pastel pink / pastel yellow, pastel pink / pink, or pastel purple / pastel green. 
    i like pink and i like lavender. the yellow is eh to me and the green is nice ig but i alr have 
    a light green from my animal crossing edition switch anyways. i wish they sold pink/lavender 
    but that's not happening so idk surprise me or something
    </p>
    </>),
    tags: [{
      text: 'games',
